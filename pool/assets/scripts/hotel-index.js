;(function(){
    ...
    var attractions = [
        ...
        var greenlocal = 'imagesnew/hotel/hotel-icon1.png';
        ...
        if($('.nav-left li a').hasClass('active')) {
            ...
            if( location=='lhasa-hotels' ){
                latlng =  new google.maps.LatLng(29.64704578172058, 91.14141401943789);
            }
            if( location=='gyantse-hotels'){
                latlng = new google.maps.LatLng(28.908927157641713, 89.6045994758606);
            }
            if( location=='tingri-ebc'){
                latlng = new google.maps.LatLng(28.63291394726706, 87.17448860406876);
            }
            if( location=='zhangmu-hotels'){
                latlng = new google.maps.LatLng(27.98532305497405, 85.98381847143173);
            }
            if( location=='shannan-hotels'){
                latlng = new google.maps.LatLng(29.23196098171095, 91.77076488733292);
            }
            if( location=='nyingchi-hotels'){
                latlng = new google.maps.LatLng(29.66639420415487, 94.35520201921463);
            }
        } else {
            //地图中心位置
