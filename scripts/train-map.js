;( function(){
    ...
    ['icon-chengdu','Chengdu Railway Station','<img class="attraction-pic" src="images/train/chengdu-railway-station-210.jpg" />'+
    ...
    ['icon-xian','Xian Railway Station','<img class="attraction-pic" src="images/train/xian-station-210.jpg" />'+
    'ff',
    '<h3>How to get there?</h3>'+
    '<p><strong>By taxi:</strong>the cost from Baiyunshan Airport to the railway station is normally around 80 RMB.</p>'+
    '<p><strong>By subway:</strong>served by Line 1 and 2.  </p>','1'
    ],
    ['icon-xining','Xining Station ','<img class="attraction-pic" src="images/train/xining-railway-station210.jpg" />'+
    ...
    ['icon-naqu','Nagqu Station','<img class="attraction-pic" src="images/train/nagqu-station-210.jpg" />'+
    ...
    ['icon-golmud','Golmud Station','<img class="attraction-pic" src="images/train/golmud-station-210.jpg" />'+
